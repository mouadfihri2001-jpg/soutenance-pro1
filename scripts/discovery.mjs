...
export function renderHomeDiscovery() {
  ...
  return `<section class="home-discovery" aria-labelledby="discovery-title"><div class="home-container">
    ...
    <div class="discovery-sourcebar"><p><strong>Plus d’un million</strong> de documents dans HAL<br><small>Toutes langues et périodes · <a href="${e(coverage.sourceUrl)}" target="_blank" rel="noopener noreferrer">Chiffres CCSD, février 2026</a></small></p><a href="/bibliotheque?scope=hal">Explorer les archives dans la bibliothèque →</a><a href="/recherche">Google Scholar, PubMed et les autres moteurs →</a></div>
  </div></section>`;
}

...
const seo=metadata({...context,title:'Soutenance Pro AI',description:'Assistant pour PFE ISPITS, mémoire et thèse de médecine : plan, sources, rédaction et soutenance.'});

...
import { countryPages } from './country-pages.mjs';
import { additionalTemplateResources } from './template-catalog.mjs';

export const pages = [...healthPages, ...libraryPages, memoirePage, ...researchGuides, ...advancedGuides, ...countryPages];
